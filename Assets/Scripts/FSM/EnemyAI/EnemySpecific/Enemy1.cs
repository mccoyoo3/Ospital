...
public class Enemy1 : Entity
{
    ...
    public E1_LockerState lockerState { get; private set; }
    public E1_LockerBehaviorState lockerBehaviorState { get; private set; }
    ...
    [SerializeField]
    private D_LockerState lockerStateData;
    [SerializeField]
    private D_LockerBehaviorState lockerBehaviorStateData;
    [SerializeField]
    ...
    public override void Awake()
    {
        ...
        lockerState = new E1_LockerState(this, stateMachine, "locker", lockerStateData, this);
        lockerBehaviorState = new E1_LockerBehaviorState(this, stateMachine, "lockerBehavior", lockerBehaviorStateData, this);
    }
