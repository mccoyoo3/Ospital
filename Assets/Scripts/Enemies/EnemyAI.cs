...
namespace FSMState.Roland
{
    public class EnemyAI : MonoBehaviour
    {
        ...
        public EnemyStatus enStats = new EnemyStatus();
        ...
        public void ChangeState(AIState targetState)
        {
            ...
            switch (targetState)
            {
                ...
                case AIState.inSearch:
                    ...
                    enStats.maxBehaviorLife = CommonBehaviours.searchLife + bhlifeOffset;
        ...
        void IdleBehaviours()
        {
            ...
            //State.PatrolBehaviour();
            CommonBehaviours.PatrolBehavior(this);
        }
        ...
        void InViewBehaviors()
        {
            ...
            RotateTowardsTarget();
            //State.ChaseBehavior();
            CommonBehaviours.ChaseBehavior(this);
        }
        ...
        {
           CommonBehaviours.SearchBehavior(this);
            Sight();
        }
